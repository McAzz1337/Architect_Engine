...
ARCHT_PLATFORM_WINDOWS (only a very small piece of code relies on the windows header, which easily can be rewritten for MacOs and Linux)<br />
...
# Notes
Some assets that are harcoded by string are not available in the repository, thus the program will crash when you run it.
